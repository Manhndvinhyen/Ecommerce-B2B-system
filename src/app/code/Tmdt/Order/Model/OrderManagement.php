...
namespace Tmdt\Order\Model;

use Magento\Framework\App\ResourceConnection;
use Tmdt\Order\Api\OrderManagementInterface;
...
class OrderManagement implements OrderManagementInterface
{
    ...
    public function __construct(
        ...
        ?\Tmdt\Order\Model\OrderProcessor $orderProcessor = null,
        ...
        $this->orderProcessor = $orderProcessor
            ?: $objectManager->get(\Tmdt\Order\Model\OrderProcessor::class);
